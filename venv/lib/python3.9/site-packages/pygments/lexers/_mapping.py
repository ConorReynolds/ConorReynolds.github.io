...
LEXERS = {
    ...
    'DafnyLexer': ('pygments.lexers.dafny', 'Dafny', ('dafny',), ('*.dfy',), ()),
    ...
    'EventBLexer': ('pygments.lexers.eventb', 'Event-B', ('eventb', 'event-b'), (), ()),
    ...
    'PollenLexer': ('pygments.lexers.pollen', 'Pollen Markup', ('pollen',), ('*.*.pm',), ()),
