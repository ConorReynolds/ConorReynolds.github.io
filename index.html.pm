...
I'm working on formalising the theory of institutions in Coq, with the institution for Event‑B as a primary use-case---supervised by Prof Rosemary Monahan and funded by the ◊extlink["https://research.ie/"]{Irish Research Council}. The formalisation is open source and available ◊extlink["https://github.com/ConorReynolds/coq-institutions"]{on my GitHub}.
